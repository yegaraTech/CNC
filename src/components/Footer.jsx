...
<footer className="bg-white dark:bg-gray-900">
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-around gap-12">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-1 sm:grid-cols-4">
              ...
              <div>
                  ...
                  <ul className="text-gray-500 dark:text-gray-400 font-medium">
                      <li className="mb-4">
                          <a href="" className="hover:underline">Sales: ydereje99@gmail.com</a>
                      </li>
                      <li className="mb-4">
                          <a href="" className="hover:underline">Support: info@yegaratech.com</a>
                      </li>
                      <li>
                          <a href="" className="hover:underline">Tel: +251982791707/+251930252577</a>
                      </li>
                  </ul>
              </div>
          </div>
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="" className="hover:underline">MarkonTech™</a>. All Rights Reserved.
          </span>
