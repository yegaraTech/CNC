...
<footer className="bg-white">
    <div className="">
          ...
          <div data-aos="fade-up" data-aos-anchor-placement="center-bottom" className="grid grid-cols-2 md:grid-cols-4 ">
              ...
              <div>
                  ...
                  <ul className="text-gray-500  font-medium">
                      ...
                      <li>
                          <a href="" className="hover:underline">Tel:
                                <p> +251982791707</p>
                                <p>+251930252577</p>
                          </a>
                      </li>
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center ">© 2023 <a href="" className="hover:underline">MarkonTech™</a>. All Rights Reserved.
          </span>
