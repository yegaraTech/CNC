  ...
  return (
   ...
   <img src={cncVideo} className='absolute z-[-2] w-full' />
    ...
    <div data-aos="fade-right" data-aos-duration="1000" className="container mx-auto flex flex-col p-2 md:p-12 gap-6">
        <h1 className="font-bold text-4xl lg:text-8xl  font-['Poppins'] ">{t('body1')}</h1>
        <h1 className="font-bold text-4xl lg:text-8xl   font-['Poppins'] ">{t("body2")}</h1>
        <p className=" text-stone-500 text-4xl font-semibold font-['Open Sans']">Cut-N-Ceate</p>
